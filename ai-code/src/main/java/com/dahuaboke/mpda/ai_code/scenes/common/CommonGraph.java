...
import com.dahuaboke.mpda.ai_code.scenes.common.edge.CommonDispatcher;
 ...
 */
@Component
public class CommonGraph extends AbstractGraph {
    ...
    public Map<Object, StateGraph> buildGraph(KeyStrategyFactory keyStrategyFactory) throws MpdaGraphException {
        try {
            StateGraph stateGraph = new StateGraph(keyStrategyFactory)
                    ...
                    .addConditionalEdges("llm", edge_async(commonDispatcher),
