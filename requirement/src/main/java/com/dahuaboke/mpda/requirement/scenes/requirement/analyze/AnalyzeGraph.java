...
import com.dahuaboke.mpda.requirement.scenes.requirement.analyze.edge.AnalyzeDispatcher;
 ...
 */
@Component
public class AnalyzeGraph extends AbstractGraph {

    @Autowired
    private AnalyzeDispatcher analyzeDispatcher;
    ...
    public Map<Object, StateGraph> buildGraph(KeyStrategyFactory keyStrategyFactory) throws MpdaGraphException {
        try {
            StateGraph stateGraph = new StateGraph(keyStrategyFactory)
                    ...
                    .addConditionalEdges("llm", edge_async(analyzeDispatcher),
