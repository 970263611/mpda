...
import com.dahuaboke.mpda.requirement.scenes.requirement.document.edge.DocumentDispatcher;
 ...
 */
@Component
public class DocumentGraph extends AbstractGraph {
    ...
    public Map<Object, StateGraph> buildGraph(KeyStrategyFactory keyStrategyFactory) throws MpdaGraphException {
        try {
            StateGraph stateGraph = new StateGraph(keyStrategyFactory)
                    ...
                    .addConditionalEdges("llm", edge_async(documentDispatcher),
