...
import com.dahuaboke.mpda.requirement.scenes.requirement.split.edge.SplitDispatcher;
 ...
 */
@Component
public class SplitGraph extends AbstractGraph {

    @Autowired
    private SplitDispatcher splitDispatcher;
    ...
    public Map<Object, StateGraph> buildGraph(KeyStrategyFactory keyStrategyFactory) throws MpdaGraphException {
        try {
            StateGraph stateGraph = new StateGraph(keyStrategyFactory)
                    ...
                    .addConditionalEdges("llm", edge_async(splitDispatcher),
