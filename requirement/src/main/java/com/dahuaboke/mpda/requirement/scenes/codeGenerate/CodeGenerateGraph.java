package com.dahuaboke.mpda.requirement.scenes.codeGenerate;
...
import com.dahuaboke.mpda.requirement.scenes.codeGenerate.edge.CodeGenerateDispatcher;
import com.dahuaboke.mpda.requirement.scenes.smallTalk.SmallTalkScene;
...
public class CodeGenerateGraph extends AbstractGraph {
    ...
    @MemoryMerge(SmallTalkScene.class)
    @Override
