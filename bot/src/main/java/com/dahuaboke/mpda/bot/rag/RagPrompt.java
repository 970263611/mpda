...
public class RagPrompt {
    ...
    public static final String FUND_CLASSIFIER = """
            ...
            1. 总共有五个判断条件,你需要严格依赖顺序,分析基金分类,规则需依次校验,前一个判断成功(满足),才执行下一个,若前一个失败(不满足),则直接中止后续判断,计算基金分类规则如下,:
                （1）第一步: 信用债基金/利率债基金判定(不满足则直接过滤,不进入后续判断)
                    ...
                    判定逻辑:
                        - 若利率债持仓占比≥80%,则为利率债基金,进入第二步判断；
                        - 若信用债持仓占比≥80%,则为信用债基金,进入第三步判断；
                        - 若两者占比<80%，直接返回 '0',终止分类流程。
                （2）第二步: 利率债基金投资风格筛选(第一步满足利率债基金才执行,不满足则终止)
                    对筛选出的利率债基金,分析基金投资策略，判定逻辑：
                    - 必须包含关键词：“灵活”、“超额收益”、“动态”、“高于基准”、“积极”、“主动”、“增强” 其中之一时。 返回 '3',终止分类流程.
                    - 必须不包含关键词：“灵活”、“超额收益”、“动态”、“高于基准”、“积极”、“主动”、“增强” 其中之一时。必须包含关键词：“复制”、“复刻”、“跟踪”、“成份券” 其中之一时。则投资风格为被动型,进入第四步判断；
                    - 必须不包含关键词：“灵活”、“超额收益”、“动态”、“高于基准”、“积极”、“主动”、“增强” 其中之一时。必须不包含关键词：“复制”、“复刻”、“跟踪”、“成份券” 其中之一时。返回0,终止分类流程.
                （3）第三步: 信用债基金投资风格筛选(第一步满足信用债基金才执行,不满足则终止)
                    对筛选出的信用债基金,分析基金投资策略，判定逻辑：
                    - 必须包含关键词：“灵活”、“超额收益”、“动态”、“高于基准”、“积极”、“主动”、“增强” 其中之一时。 返回 '2',终止分类流程.
                    - 必须不包含关键词：“灵活”、“超额收益”、“动态”、“高于基准”、“积极”、“主动”、“增强” 其中之一时。必须包含关键词：“复制”、“复刻”、“跟踪”、“成份券” 其中之一时。返回 '1',终止分类流程；
                    - 必须不包含关键词：“灵活”、“超额收益”、“动态”、“高于基准”、“积极”、“主动”、“增强” 其中之一时。必须不包含关键词：“复制”、“复刻”、“跟踪”、“成份券” 其中之一时。返回 '0',终止分类流程.
                 (4）第四步: 被动型利率债期限分类(第二步满足投资风格被动性才执行,不满足则中止)
                    对于投资风格为被动型的利率债基金，分析基金简称，按以下规则细分：
                    - 基金简称中包含“1-3”时，分类为“利率债指数1-3年”,返回 '4'，终止流程
                    - 基金简称中包含“3-5”时，分类为“利率债指数3-5年”,返回 '5'，终止流程
                    - 基金简称中包含“1-5”时，分类为“利率债指数1-5年”,返回 '6'，终止流程
                    - 若均不包含,返回 '0',终止流程
            2. 计算后的结果只有7种,以下为映射关系
                             "0":"无",
                             "1":"信用债-指数型",
                             "2":"信用债主动-开放式",
                             "3":"利率债主动-开放式",
                             ...
                             "5":"利率债指数3-5年",
                             "6":"利率债指数1-5年"
                             必须从这0-6中选一个数字作为结果,以及选择的原因       
            3. 根据最终答案和用户查询问题,分析结果和整理格式 ,并将最终结果0-6 和原因 放在『RESULT』和『END』之间：
            	  <think>思考过程...</think>
            	  『RESULT』
            		 结果 || 原因
            	  『END』
